...
insert into fin_instrumento (id, nombre, ticker, mercado_id) values (1, 'YPF', 'YPFD', 1);
insert into fin_broker (id, codigo, nombre) values (1, 'IOL','Invertir Online');
insert into fin_cartera (id, broker_id) values (1, 1);
...
(id, activo_id, cartera_id, instrumento_id, cantidad, fecha, precio, tipo) values
(1, 1, 1, 1, 10, '2021-01-04', 610.50, 'C');
